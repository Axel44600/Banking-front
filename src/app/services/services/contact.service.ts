...
export class ContactService extends BaseService {
   ...
   */
  static readonly FindById2Path = '/contacts/{id}';
   ...
   */
  static readonly Delete2Path = '/contacts/{id}';
   ...
   */
  static readonly FindAllByUserId1Path = '/contacts/user/{id}';
